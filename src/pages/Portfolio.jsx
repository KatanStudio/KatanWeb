...
const PROJECTS = [
  ...
  },
  {
    ...
    solution: 'Landing page de alto impacto con formulario de captación de leads en 10 pasos conectado a HubSpot. Cada formulario completado genera automáticamente un contacto directo con el equipo de ventas. Identidad visual completa creada por Katan.',
  ...
  },
  {
    ...
    tag: 'Web Corporativa',
    title: 'Katan',
    problem: 'Como agencia, necesitábamos un sitio que no solo describiera nuestros servicios, sino que los demostrara: que cualquier visitante entendiera desde el primer clic a qué nivel trabajamos.',
    solution: 'Plataforma propia construida a medida con animaciones fluidas, flujo de contacto personalizado y arquitectura React + Vite optimizada para rendimiento y SEO.',
    technologies: ['React', 'Vite', 'CSS', 'Figma'],
    external: false,
  },
  {
    href: '#',
    ...
    solution: 'Web profesional con fichas técnicas de las salas, discografía enlazada a Spotify y Apple Music, y presentación del equipo. Ahora el estudio se vende solo antes del primer contacto.',
  ...
  },
  {
    ...
    problem: 'Diseñadora que necesitaba un espacio digital minimalista y elegante para exhibir sus casos de estudio y atraer a nuevos clientes o agencias y mostrar sus diseños.',
  ...
  },
  {
    ...
    tag: 'Web Personal',
    title: 'Portfolio DJ & Productor',
    problem: 'DJ que buscaba profesionalizar su marca personal, centralizando sus fechas de eventos, links a plataformas de streaming (Soundcloud) y un press kit para promotores.',
